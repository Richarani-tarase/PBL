    ...
    <div className="min-h-screen bg-zinc-900 text-zinc-100 p-6 font-mono">
      <div className="grid grid-cols-2 gap-6 max-w-7xl mx-auto mb-6">
        ...
        <div className="bg-zinc-800 border border-zinc-700 rounded-xl p-4">
          <h1 className="text-xl font-bold text-lime-400 mb-2">
            📘 Matrix DSL Guide
          </h1>
          <ul className="text-sm text-zinc-300 list-disc list-inside space-y-1">
            <li>
              Declare matrices using{" "}
              <code className="text-lime-300">matrix A = [[1, 2]; [3, 4]]</code>
            </li>
            <li>
              Use <code className="text-lime-300">A.T</code> for transpose
            </li>
            <li>
              Use <code className="text-lime-300">A.inv</code> for inverse
            </li>
            <li>
              Support for <code className="text-lime-300">+, -, *</code>{" "}
              operations
            </li>
            <li>
              Separate rows with <code className="text-lime-300">;</code> and
              values with <code className="text-lime-300">,</code>
            </li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto bg-black border border-zinc-700 rounded-xl p-4">
        <h2 className="text-lime-400 mb-2">🖥 Output Console</h2>
